...
#create dataset
dataset = pd.read_csv(f"../../datasets/loan_data{file_name}.csv", header= 0)
...
train_data.to_csv(f"training_data{file_name}.csv", index=False)
validation_data.to_csv(f"validation_data{file_name}.csv", index=False)
test_data.to_csv(f"test_data{file_name}.csv", index=False)