...
axes[0][0].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[0][3].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[1][0].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[1][2].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[2][0].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[2][1].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[2][2].set_ylabel('Number of Persons (log)', fontsize=12)
...
axes[2][3].set_ylabel('Number of Persons (log)', fontsize=12)
